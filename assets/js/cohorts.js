...
window.cohorts = [
  {
    ...
    status: "활동 마무리",
    statusClass: "done",
    /* 참여자 수는 명단으로 세지 않습니다. 성함이 확인된 분만 members에 싣습니다. */
    participants: 16,
    summary:
      "제주에서 시작한 첫 기수입니다. 교육·기업·공공·목회·마케팅·디자인 분야의 참여자가 한 달 동안 주 1회 만나 각자의 업무 스킬을 만들고 피드백을 나눴습니다.",
    goal: "개인당 스킬 1개 이상. 실제 업무에 바로 투입할 수 있는 완성도를 목표로 했고, 최종 피드백을 거쳐 GitHub 공개 저장소와 홈페이지에 올립니다.",
    facts: [
